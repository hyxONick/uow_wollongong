...
const h1 = "text-3xl font-semibold tracking-tight lg:text-5xl";
const h2 = "pb-2 text-3xl font-semibold tracking-tight first:mt-0";
const h3 = "text-2xl font-semibold tracking-tight";
const h4 = "text-xl font-semibold tracking-tight";
const p = "leading-7";
...
export const Typography = {
  ...
  mute: typographyFactory("small", mute),
};